...
const dog2 = {
    ...
    sound: '멍멍',
    say: function say() {
        console.log(this.sound);    // this는 dog2
    }
};
...
const dog3 = {
    ...
    sound: '멍멍',
    say: () => {
        console.log(this.sound);    // 타입 에러 undefined(sound에 대해서)
    }
};
...
const numbers = {
    a: 1,
    b: 2,
    get sum() { // Getter 함수 : 특정값을 조회 시 설정한 함수로 연산된 
